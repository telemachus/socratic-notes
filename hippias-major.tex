...
If you put this all together, it seems incredible that the Spartans don't hire Hippias for their children, but Hippias explains that it is not traditional ({\g πάτριον} 284b6) to change their laws nor to educate their sons in uncustomary ways. And it is not customary ({\g νόμιμον} 284c5) for children to receive education from non-Spartans.
...
\begin{enumerate}
    ...
    \item In the sentence {\g παρθένος καλὴ καλόν}, \word{beautiful} is not a bona fide general term. Instead it has a peculiar, strong sense, close to what we would mean by the expression ``is to be beautiful".
