...
\begin{enumerate}
    ...
    \item In the sentence \foreign{παρθένος καλὴ καλόν}, ``beautiful" is not a bona fide general term. Instead it has a peculiar, strong sense, close to what we would mean by the expression ``is to be beautiful".
