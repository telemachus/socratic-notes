...
% {{{ Preliminaries: Euthyphro's and Socrates' trials (2--4e3)
\section{Preliminaries (2--4a3)}
...
% {{{ Definitions (4e4--15c10)
\section{Definitions (4e4--15c10)}
...
% {{{ Euthyphro's first definition (5d8--6a5)
\subsection{Euthyphro's first definition (5d8--6a5)}
...
% {{{ Socrates rejects Euthyphro's first definition (6a6--6d10)
\subsection{Socrates rejects Euthyphro's first definition (6a6--6d10)}
...
% {{{ Euthyphro's second definition (6e11--7a1)
\subsection{Euthyphro's second definition (6e11--7a1)}
...
% {{{ Socrates refutes Euthyphro's second definition (7a2--8b6)
\subsection{Socrates refutes Euthyphro's second definition (7a2--8b6)}
...
\begin{enumerate}
    ...
    \item Among humans, only \emph{some} disagreements lead to this kind of
        fighting and enmity. For example, if people disagree about a number
        or measurement, that doesn't lead to such a fight. Those kinds of
        problems are solved easily enough by counting, measuring or
        weighing. But disagreements about justice and injustice, beauty and
        ugliness, good and bad~--- those disagreements lead to fighting and
        enmity. They do so because in those cases people ``are unable to
        come to a sufficient agreement" (7d3--4).
...
the gods agree about one thing at least: that whoever kills someone
...
% {{{ Euthyphro's second definition reformulated (9c--10)
\subsection{Euthyphro's second definition reformulated (9c--10)}
...
% {{{ Socrates refutes the second definition, in all forms (10--11b5)
\subsection{Socrates refutes the reformulated second definition (10--11b5)}

This next argument is probably the dialogue's most important legacy.
% }}}
