...
% {{{ Socrates' case (2--3e7)
\subsection{Socrates' case (2--3e7)}
...
% {{{ Definitions (4e3--15c10)
\section{Definitions (4e3--15c10)}

% {{{ Pre-definition methodology (4e3--5d7)
...
% {{{ Euthyphro's first definition (5d8--6a6)
\subsection{Euthyphro's first definition (5d8--6a6)}
