...
\begin{enumerate}
    ...
    \item There is a strong hint in 43a8 that Crito has bribed a guard. John Burnet denies that Crito gave the guard money. He claims that the phrase \textgreek{καί τι καὶ εὐεργέτηται ὑπ᾽ ἐμοῦ} ``characterizes the kindly Crito at once. The man is under an obligation to him, which should not be vulgarized into a `tip' with some editors.''\footcite[][ad 43a8]{burnet1924-euthyphro-apology-crito} But this is no argument at all: something can be vulgar and yet true. Brickhouse and Smith cite Burnet approvingly, and they add, ``there is no reason to think that Crito has done anything more than been of assistance to the guard in some undisclosed way in the past. There is no reason to think that this is a reference to bribery.''\footcite[][249]{brickhouse-smith2004-plato-trial-of-socrates}  I believe that these scholars deny the clear implication of the Greek, though I grant that I can't prove this either. On the other side, Louis Dyer, James Adam, and Gil Rose believe that Crito gave the guard money.\footcites[][ad 43a9]{dyer-apology-crito-2007}[][ad 43a9]{adam1988-crito}[][ad 43a8]{rose1983} This suggests immediately that Crito is someone who solves problems with money.
